package UMLparser;
	...
	public class ChechDependency {
			...
			public ChechDependency(String className,MethodDeclaration md)
			{
				this.className=className;
				this.md=md;
			
			}
			public ChechDependency(String className,ConstructorDeclaration cd)
			{
				this.className=className;
				this.cd=cd;
